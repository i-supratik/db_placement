...
include "connect.php";
      ...
      <div class="box">
        <!--<div class="box-header with-border">
          ...
          <form action="intern.php" method="get">
        	<div class="form-group">
		            	<label>Internship/Project</label>
		            	<input class="form-control" placeholder="Internship/Project" type="text" id="intern" name ="intern" required value="">
		            </div>
              <div class="form-group">
		            	<label>Company</label>
		            	<input class="form-control" placeholder="Company" type="text" id="comp" name ="comp" required value="">
		            </div>
              <div class="form-group">
		            	<label>Duration</label>
		            	<input class="form-control" placeholder="in Months" type="number" id="dur" name ="dur" required value="">
		            </div>
        	<div class="row">  
