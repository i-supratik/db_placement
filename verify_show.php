...
<div class="wrapper">
  ...
  <div class="content-wrapper">
          ...
          if(!empty($_REQUEST['rid']))
    {
        ...
        $sql40="SELECT verified FROM student WHERE SID='$rid'";
        $res40=$conn->query($sql40);
        $row40=$res40->fetch_assoc();
        ...
        <div class="box">
            ...
            <div class="row">
      		...
      		<form action="verify_update.php" method="get">
        	<div class="row">
	        	<div class="form-group col-lg-6 col-xs-12">
	          		<label style="padding: 10px;">verified(yes/no):</label><input type="text" id="ID" style="width: 100%;" name="ver" value="<?php $row40['verified'] ?>"/>
	          	</div>	
        	</div>
